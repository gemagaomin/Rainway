...
public class FileTempService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        thread.start();
        this.bindService(new Intent(FileTempService.this, FileService.class), mServiceConnection, Context.BIND_IMPORTANT);
        Log.d("fileTimepService");
        ...
        builder.setTicker("守护服务FileTempService启动中")
                .setContentText("我是来守护服务FileService的")
                .setContentTitle("守护服务FileTempService")
    ...
    public class FileTempBinder extends Binder {
        FileTempService getService() {
            return FileTempService.this;
        }
    }
    ...
    class MyServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            android.util.Log.d("test","FileTempService:建立链接");
        }

        @Override
        public void onServiceDisconnected(ComponentName componentName) {
            FileTempService.this.startService(new Intent(FileTempService.this, FileService.class));
            FileTempService.this.bindService(new Intent(FileTempService.this, FileService.class), mServiceConnection, Context.BIND_IMPORTANT);
        }
    }
